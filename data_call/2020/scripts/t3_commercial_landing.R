...
config_file <- configuration_file(new_config = F,
                                  path_config = "D:\\IRD\\projets_themes\\03_data_calls\\04-RDBES\\2020\\3-data\\configfile_rdbes2020.csv")
...
#observe_con <- db_connection(db_user = config_file[["observe_user"]],
#                             db_password = config_file[["observe_password"]],
#                             db_dbname = config_file[["observe_dbname"]],
#                             db_host = config_file[["observe_host"]],
#                             db_port = config_file[["observe_port"]])

# Table CL, Commercial Landing
t3_cl_query <- paste(readLines(con = file.path(config_file[["queries_loc"]],
...
balbaya_cl_query <- paste(readLines(con = file.path(config_file[["queries_loc"]],
