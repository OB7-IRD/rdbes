...
--	, 0::integer as "SSseqNum"
--	, 'Y/N'::text as "SSstratification"
	, 'SORT'::text as "SSobsActTyp"
 , 'Lan'::text as "SScatchFra"
 , 'vol'::text as "SSobsTyp"
 , 'U'::text as "SSstratumName"
-- , ''::text as "SSclustering"
-- , ''::text as "SSclusterName"
 , 'Observer'::text as "SSsampler"
 , 'IRD_specie_list'::text as "SSspecListName"
 , 'No'::text as "SSuseCalcZero"
 , '1'::text as "SSnumTotal"
-- , count(distinct ee.c_esp) as "SSnumSamp"
-- , ''::text as "SSselProb"
-- , ''::text as "SSincProb"
...
--	join public.echant e2 on (e2.c_bat = m2.c_bat and e2.d_dbq = m2.d_dbq) 
